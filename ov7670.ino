...
void setup() {
  ...
  config.xclk_freq_hz = 20000000;  // Untuk OV7670, XCLK bisa sekitar 20 MHz
  config.pixel_format = PIXFORMAT_RGB565;  // OV7670 tidak mendukung JPEG, gunakan RGB565 atau YUV

  config.frame_size = FRAMESIZE_VGA;  // Resolusi 640x480
  config.jpeg_quality = 12;  // Tidak berpengaruh karena tidak mendukung JPEG
  config.fb_count = 1;  // Gunakan buffer tunggal
...
void startCameraServer() {
  // Implementasi untuk menangani stream RTSP dari kamera OV7670
